    ...
    <Layouts>
      <section className="relative flex w-full flex-col items-center justify-evenly py-40 md:h-screen md:flex-row md:overflow-hidden">
        ...
        <motion.div {...ContentAnimation} className="relative order-1 w-1/3 md:order-2">
          <h3 className="-mb-5 text-base font-normal">Hi! My Name Is\n</h3>
          <h1 className="-ml-1 mb-1 text-7xl font-bold text-primary-light">Я-Xyz</h1>
          <h4 className="text-sm font-light transition-all duration-500 hover:text-primary-light">Learner JavaScript</h4>
        </motion.div>
      </section>
    </Layouts>
  );
