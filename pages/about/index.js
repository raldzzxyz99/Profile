      ...
      <section className="relative flex w-full flex-col items-center justify-evenly py-40 md:h-screen md:flex-row md:overflow-hidden">
        ...
        <motion.div {...ContentAnimation} className="relative order-1 my-10 w-3/4 text-justify md:order-2 md:my-0 md:w-1/4">
          <p className="text-md font-light text-primary-light">
            {`Hello! My name is N-ꓘiuuR, you can call me Kyuu, or whatever you want. I'm a beginners who are learning JavaScript, located in South Sulawesi, Indonesia. As a Front-end Develover I used to code websites from stratch. I love to create simple yet beautiful websites with great user experience.`}
          </p>
        </motion.div>
      </section>
    </Layouts>
